...
heading= Label(root, text='TODAS AS TAREFAS', font='arial 20 bold', fg="white", bg='#32405b', anchor=CENTER)
heading.place(relx=0.14,rely=0.03)
...
button = Button(frame, text="ADC", font="arial 20 bold", width=6, bg="#5a95ff", fg="#fff", bd=0, command=addTask)
